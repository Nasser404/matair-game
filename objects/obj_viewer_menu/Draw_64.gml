...
if (global.game_list == undefined) {
    ...
    _x            = 32;
    _y            = 96;
    for (var i = list_index, n = array_length(global.game_list); i < min(list_index + max_list_index, n); i++) {
        ...
        draw_game_info(_x, _y, global.game_list[i]);
        _y+=_h+8;
    ...
    var _total_pages = (array_length(global.game_list)-1) div max_list_index
